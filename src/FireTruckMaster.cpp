...
void setup()
{
    ...
    Serial.print("Starting Fire Truck Master Test");
...
void sendData()
{
    ...
    Wire.write(data);                // Sends serial data
...
void loop()
{
    ...
    //         if (printTouch)
    //         {                                               // Print the x, y coordinates of the touchpad
    //             if (PS4.isTouching(0) || PS4.isTouching(1)) // Print newline and carriage return if any of the fingers are touching the touchpad
    //                 Serial.print(F("\r\n"));
    //             for (uint8_t i = 0; i < 2; i++)
    //             { // The touchpad track two fingers
    //                 if (PS4.isTouching(i))
    //                 { // Print the position of the finger if it is touching the touchpad
    //                     Serial.print(F("X"));
    //                     Serial.print(i + 1);
    //                     Serial.print(F(": "));
